                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="mt-24 bg-[#111827] rounded-3xl p-12 md:p-20 text-center relative overflow-hidden group">
                            ...
                            <div className="relative z-10 max-w-3xl mx-auto">
                                ...
                                <button className="px-8 py-4 bg-[#FF8A00] text-white rounded-full font-bold uppercase tracking-wider hover:bg-[#ff9f33] hover:shadow-[0_10px_30px_rgba(255,138,0,0.4)] transition-all duration-300">
                                    Start Your Project
                                </button>
                            </div>
                        </div>
